local Translations = {
    ...
    client = {
        ...
        lang_8 = 'Rent',
        lang_9 = 'Boss Menu',
        lang_10 = 'Gunsmith Closed!',
        lang_11 = 'Gunsmith Customer Menu',
        lang_12 = 'View Stock Items',
        lang_13 = 'Gunsmith Counter',
        lang_14 = 'Gunsmith Rent Menu',
        lang_15 = 'Rent Money : $',
        lang_16 = 'Add Rent Money',
        lang_17 = 'Gunsmith Stock',
    ...
    server = {
        lang_1 = 'Not enough ',
        lang_2 = 'You rented this Gunsmith',
        lang_3 = 'Not enough money to rent!',
        lang_4 = 'Rent Updated',
        lang_5 = 'Missing Items',
        lang_6 = 'Gunsmith rent cronjob ran',
    },
